...
(function () {
  ...
  const PC_BUILD_DATA = {
    ...
    buildTemplates: [
      {
        ...
        description: 'High value-to-cost ratio for ROS 2 Humble node development, OpenCV camera pipelines, and light simulation.',
        components: {
          cpu: 'cpu-budget',
          gpu: 'gpu-budget',
      ...
      {
        id: 'build-budget-itx',
        name: 'ROS 2 & Gazebo Sim Box',
        tier: 'budget',
        tierLabel: 'Entry Tier',
        tag: 'Gazebo Simulation & Kinematics',
        description: 'Compact airflow desktop rig powered by Ryzen 5 5600 and RX 7600 XT 16GB VRAM for 3D physics rendering.',
        components: {
          cpu: 'cpu-budget',
          gpu: 'gpu-amd-budget',
          motherboard: 'mb-budget',
      ...
      },
      {
        ...
        name: 'Vision & SLAM Rig Pro',
        tier: 'gaming',
        tierLabel: 'Mid-Tier Workstation',
        tag: '3D LiDAR SLAM & CUDA Vision',
        description: 'Powered by Ryzen 7 7800X3D and RTX 4070 Super 12GB for real-time point cloud registration and neural object tracking.',
        components: {
          cpu: 'cpu-gaming',
          gpu: 'gpu-mid',
      ...
      {
        id: 'build-gaming-vr',
        name: 'Autonomous Drone & Flight Sim Station',
        tier: 'gaming',
        tierLabel: 'Mid-Tier Workstation',
        tag: 'PX4 Flight Sim & Stereo Perception',
        description: 'Core i7-14700K paired with RTX 4070 Ti Super 16GB for multi-vehicle drone simulation and high-resolution depth mapping.',
        components: {
          cpu: 'cpu-intel-i7',
          gpu: 'gpu-4070-ti',
      ...
      },
      {
        ...
        name: 'AI Deep Learning Cyber-Titan',
        tier: 'enthusiast',
        tierLabel: 'Enthusiast Tier',
        tag: 'PyTorch Fine-Tuning & Local LLM',
        description: 'Core i9-14900K and RTX 4080 Super monster engineered for deep reinforcement learning, TensorRT model quantization, and local LLM inferencing.',
        components: {
          cpu: 'cpu-enthusiast',
          gpu: 'gpu-gaming',
          motherboard: 'mb-intel',
      ...
      },
      {
        ...
        name: 'Creator 3D CAD & Simulation Studio',
        tier: 'enthusiast',
        tierLabel: 'Enthusiast Tier',
        tag: 'NVIDIA Isaac Sim & SolidWorks CAD',
        description: 'Ryzen 9 7950X3D with RX 7900 XTX 24GB VRAM and 64GB DDR5 for complex robot mechanical CAD modeling and Isaac Sim photorealistic environments.',
        components: {
          cpu: 'cpu-amd-7950x3d',
          gpu: 'gpu-amd-7900xtx',
          motherboard: 'mb-gaming',
      ...
      },
      {
        ...
        description: 'Threadripper 7970X paired with RTX 4090 24GB and 128GB ECC RAM for intensive swarm simulations, large vision-language-action (VLA) models, and multi-tenant lab nodes.',
        components: {
          cpu: 'cpu-workstation',
          gpu: 'gpu-flagship',
    ...
    orders: [
      ...
      {
        id: 'ord-1002',
        customerName: 'Sora Chen',
        customerEmail: 'schen@autonomousai.io',
        buildTitle: 'AI Deep Learning Cyber-Titan',
        tier: 'enthusiast',
        totalPrice: 2686,
